...
[CreateAssetMenu(menuName = "Inventory/Database", fileName = "Database")]
public class Database : ScriptableObject
{
    [SerializeField] List<InventoryItemData> _itemDatabase;

    [ContextMenu("Set IDs")] // Todo: Make it so it updates on builds
